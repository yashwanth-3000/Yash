...
export function GlowEffect({
  className,
  style,
  colors = ['#ef4444', '#b91c1c', '#7f1d1d', '#dc2626'],
  mode = 'rotate',
  blur = 'medium',
  transition,
  scale = 1,
  ...
  const getBlurClass = (blur: GlowEffectProps['blur']) => {
    ...
    return { softest: 'blur-sm', soft: 'blur', medium: 'blur-md', strong: 'blur-lg', stronger: 'blur-xl', strongest: 'blur-xl', none: 'blur-none' }[blur as string] ?? 'blur-md';
  };
